...
class mapSelector extends React.Component {
  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "row mapSelector col-sm 6 col-sm-offset-6" },
        "Select map technology "
      ),
      React.createElement(
        "div",
        { className: "row btn-group col-sm-6 col-sm-offset-6" },
        this.props.mapOptions.map(mapOption => {
          var buttonSelected = this.state.selectedMap === mapOption;
          return React.createElement(mapButton, {
            key: mapOption.value,
            mapOption: mapOption,
            selectMap: this.changeMap,
