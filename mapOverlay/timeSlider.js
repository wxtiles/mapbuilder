...
class timeSlider extends React.Component {
  ...
  doAnimationFrame() {
    ...
    if (mapOptions.isAnimating) {
      ...
      var animationSpeed = mapOptions.animationFrameMinutes
        ? mapOptions.animationFrameMinutes
        : ((mapOptions.latestTime - mapOptions.earliestTime) / 1000 / 60) *
          0.01;
  ...
  selectTime(time) {
    this.props.selectTime({
      ...
      ignore: !this.props.mapOptions.isAnimating
    });
  }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("div", {
            onClick: this.halveSpeed,
            className: "speed-button glyphicon glyphicon-minus-sign"
          }),
          React.createElement("div", {
            onClick: this.doubleSpeed,
            className: "speed-button glyphicon glyphicon-plus-sign"
          })
        ),
        React.createElement(
          "div",
          { className: "reactSliderContainer" },
          React.createElement(rcSlider, {
            ...
            tipFormatter: (tip, index) => {
              var t = moment
                .duration(moment(tip).diff(moment()))
                .asMilliseconds();
              var args = {
                conjunction: " and ",
              ...
              return t > -60000 && t < 60000
                ? "now"
                : t < 0
                  ? humanizeDuration(t, args) + " ago"
                  : "in " + humanizeDuration(t, args);
            },
